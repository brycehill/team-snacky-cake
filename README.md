...
~~~sh
# getting the code
git clone git@github.com:nko4/team-snacky-cake.git && cd ./team-snacky-cake/

# developing
npm install
npm start

# deploying (to http://team-snacky-cake.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@team-snacky-cake.2013.nodeknockout.com
ssh root@team-snacky-cake.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@team-snacky-cake.2013.nodeknockout.com
ssh -i ./id_deploy root@team-snacky-cake.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/team-snacky-cake" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
